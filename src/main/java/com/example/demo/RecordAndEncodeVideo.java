...
public class RecordAndEncodeVideo {
	...
	public void mainMethod(int durationInput,int snapInput,String uniqueID) throws InterruptedException, IOException, AWTException {

		final int duration = durationInput/2; // how long in seconds
		...
		final String filename = "src/main/webapp/videosPlay/Student"+uniqueID+".mp4";
